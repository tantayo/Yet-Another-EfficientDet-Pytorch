...
def coco2kitti(catNms, annFile, outdir):
    ...
    for img in coco.imgs:
        ...
        if len(annIds) > 0:
            ...
            # open text file
            with open(outdir + img_fname.split('.')[0] + '.txt','w') as label_file:
...
if __name__ == '__main__':
    ...
    dataDir = '/home/santiago/projects/torch/build/install/eff_det/datasets/shape/'
    dataType = 'more-imgs'
    annFile = '%s/annotations/coco_instances_%s.json' % (dataDir, dataType)

    annFile = '/home/santiago/projects/torch/build/install/eff_det/datasets/shape/annotations/instances_val.json'
    outdir = '/home/santiago/projects/torch/build/install/eff_det/datasets/shape/annotations/labels/'
